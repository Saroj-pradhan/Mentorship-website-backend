...
const userSchema = new mongoose.Schema({
  ...
  id: {
    // This will act like email or unique identifier
    type: String,
    required: true,
    unique: true,
  },
...
const communitySchema = new mongoose.Schema({
  ...
  author: { 
    ...
    role: { type: String, default: "A student" },
    profilePic: {
      type: String, 
      default:
        "data:image/jpeg;base64,",
  ...
  tags: [{ type: String }],
  timeToRead: { type: String, default: "above 5 mint" },
...
const communitys = mongoose.model("community", communitySchema);
module.exports = { dbconnect, users, admins, communitys };
